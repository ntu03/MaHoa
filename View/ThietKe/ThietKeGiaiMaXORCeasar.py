# Form implementation generated from reading ui file 'D:\DETAI_BMHTTT\View\ThietKe\ThietKeGiaiMaXORCeasar.ui'
#
...
"color:black;")
        ...
        self.label_4.setGeometry(QtCore.QRect(350, 340, 181, 16))
        self.label_4.setObjectName("label_4")
        self.btnOpenFile = QtWidgets.QPushButton(parent=Dialog)
        self.btnOpenFile.setGeometry(QtCore.QRect(750, 300, 93, 28))
...
"color:black;")
        ...
        self.label_2.setGeometry(QtCore.QRect(350, 80, 181, 16))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(parent=Dialog)
        self.label_3.setGeometry(QtCore.QRect(350, 300, 131, 31))
        self.label_3.setObjectName("label_3")
        self.txtKey = QtWidgets.QTextEdit(parent=Dialog)
        self.txtKey.setGeometry(QtCore.QRect(510, 300, 111, 31))
        self.txtKey.setStyleSheet("background-color:white;\n"
"color:black;\n"
"border-radius:10px;")
        self.txtKey.setObjectName("txtKey")
        self.btnGiaiMa = QtWidgets.QPushButton(parent=Dialog)
        self.btnGiaiMa.setGeometry(QtCore.QRect(870, 300, 93, 28))
        self.btnGiaiMa.setStyleSheet("background-color: rgb(242, 219, 116);\n"
"border-radius: 10px;\n"
"border: 2px solid black;\n"
"color:black;")
        icon2 = QtGui.QIcon()
        ...
        self.label.setGeometry(QtCore.QRect(580, 10, 341, 81))
        font = QtGui.QFont()
        ...
        self.txtVanBanGoc.setGeometry(QtCore.QRect(350, 360, 611, 181))
        self.txtVanBanGoc.setStyleSheet("background-color: white;\n"
"border: 2px inset #8b6f78;\n"
"border-radius:20px;\n"
"color:black;")
        self.txtVanBanGoc.setObjectName("txtVanBanGoc")
        self.txtCiphertext = QtWidgets.QTextEdit(parent=Dialog)
        self.txtCiphertext.setGeometry(QtCore.QRect(350, 100, 611, 191))
...
"color:black;")
        ...
        self.btnClose.setGeometry(QtCore.QRect(870, 550, 93, 28))
...
"color:black;")
        ...
        self.frame.setGeometry(QtCore.QRect(20, 10, 228, 571))
...
"color:black;")
        ...
        self.page_8.setGeometry(QtCore.QRect(0, 0, 98, 85))
...
"color:black;")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Nhập nội dung cần giải mã:"))
        self.label_3.setText(_translate("Dialog", "Key:"))
        self.btnGiaiMa.setText(_translate("Dialog", "Giải mã"))
        self.label.setText(_translate("Dialog", "Giải mã XOR CEASAR"))
