    ...
    def MaHoa(self):
        ...
        if not self.textk:
            ...
            if not textpl:
                ...
                cNhieuDong= CChuyenViNhieuDong(textpl,self.textk) #khai báo đối tượng của lớp CNhieuDong
                self.c = cNhieuDong.MaHoa() #gọi hàm mã hoá của đối tượng này
                self.txtCiphertext.setPlainText(self.c) #xuất dữ liệu (chuỗi) ra text ciphertext của ThietKeMaHoaNhieuDong
    def MoFile(self):
